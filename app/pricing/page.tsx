  ...
  const plans = [
    {
      ...
      features: ["10 humanizations per day", "Free mode", "Basic rewriting", "Standard speed"],
      button: "Current Plan",
      path: "/",
    },
    {
      ...
      features: ["10,000 words/month", "Faster processing", "Better humanization", "Email support"],
      button: "Get Silver",
    ...
    },
    {
      ...
      features: ["30,000 words/month", "Fast mode", "Creative mode", "Priority support"],
      button: "Get Gold",
    ...
    },
    {
      ...
      features: ["60,000 words/month", "Premium humanization", "Maximum speed", "Early access features"],
      button: "Get Platinum",
    ...
    <main style={page}>
      <aside style={sidebar}>
        ...
        <nav style={nav}>
          ...
          <button style={activeNav}><CreditCard size={18} />Pricing</button>
...
>
        ...
        <section style={trustGrid}>
          <div style={trustCard}>
            ...
            <p style={mutedSmall}>Your content is handled privately and securely.</p>
          </div>

          <div style={trustCard}>
            <Crown color="#7c3aed" />
            <h3>Premium Modes</h3>
            <p style={mutedSmall}>Unlock faster and more advanced rewriting modes.</p>
          </div>

          <div style={trustCard}>
            <LifeBuoy color="#7c3aed" />
            <h3>Reliable Support</h3>
            <p style={mutedSmall}>Get support when you need help with your plan.</p>
          </div>
        </section>
...
const hero = { textAlign: "center" as const, marginBottom: "42px" };
const heroBadge = { display: "inline-flex", alignItems: "center", gap: "8px", background: "#f3e8ff", color: "#7c3aed", padding: "9px 15px", borderRadius: "999px", fontWeight: "bold" as const, marginBottom: "18px" };
const title = { fontSize: "48px", margin: "0 auto 14px", maxWidth: "760px", lineHeight: "1.1" };
const subtitle = { color: "#64748b", maxWidth: "680px", margin: "0 auto 28px", fontSize: "17px", lineHeight: "1.6" };
const toggleWrapper = { display: "inline-flex", background: "#fff", border: "1px solid #e5e7eb", borderRadius: "999px", padding: "6px", gap: "6px" };
const activeToggle = { padding: "10px 24px", borderRadius: "999px", border: "none", background: "#7c3aed", color: "white", fontWeight: "bold" as const, cursor: "pointer" };
const inactiveToggle = { ...activeToggle, background: "transparent", color: "#334155" };
const saveText = { color: "#16a34a", fontWeight: "bold" as const, marginTop: "14px" };

const cardsGrid = { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "22px", marginBottom: "34px" };
const card = { background: "#fff", border: "1px solid #e5e7eb", borderRadius: "22px", padding: "28px", boxShadow: "0 12px 30px rgba(15,23,42,0.05)", position: "relative" as const };
const popularCard = { ...card, border: "2px solid #8b5cf6", boxShadow: "0 18px 45px rgba(124,58,237,0.18)", transform: "translateY(-8px)" };
const popularBadge = { position: "absolute" as const, top: "-15px", left: "50%", transform: "translateX(-50%)", background: "#7c3aed", color: "white", padding: "6px 14px", borderRadius: "999px", fontSize: "12px", fontWeight: "bold" as const };
const planName = { marginTop: "12px", fontSize: "24px" };
const price = { fontSize: "32px", margin: "18px 0" };
const features = { minHeight: "170px" };
const featureItem = { display: "flex", alignItems: "center", gap: "8px", color: "#334155" };
const planButton = { width: "100%", padding: "13px", borderRadius: "12px", border: "1px solid #e9d5ff", background: "#faf5ff", color: "#7c3aed", fontWeight: "bold" as const, cursor: "pointer", boxShadow: "0 6px 16px rgba(124,58,237,0.12)" };
const popularButton = { ...planButton, border: "none", background: "linear-gradient(135deg,#8b5cf6,#7c3aed)", color: "white" };

const trustGrid = { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "20px", marginBottom: "36px" };
const trustCard = { background: "#fff", border: "1px solid #e5e7eb", borderRadius: "18px", padding: "24px", boxShadow: "0 10px 25px rgba(15,23,42,0.05)" };
const faqWrapper = { background: "#fff", border: "1px solid #e5e7eb", borderRadius: "22px", padding: "30px", boxShadow: "0 12px 30px rgba(15,23,42,0.05)" };
const sectionTitle = { textAlign: "center" as const, marginTop: 0, marginBottom: "20px" };
const faqBox = { borderTop: "1px solid #e5e7eb", padding: "18px 0" };
